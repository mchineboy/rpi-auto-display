...
func (AutoInt *AutoInterface) DrawX() {
	...
	AutoInt.Screen.DrawLine(0.0, 13-(float64(AutoInt.Display.Width)), float64(AutoInt.Display.Height), 13-(float64(AutoInt.Display.Width)))
	...
	log.Printf("%f %f %f %f\n", 0.0, 13-(float64(AutoInt.Display.Width)), float64(AutoInt.Display.Height), 13-(float64(AutoInt.Display.Width)))
