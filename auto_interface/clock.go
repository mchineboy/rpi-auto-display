...
func (AutoInt *AutoInterface) DrawClock() {
	...
	AutoInt.Screen.DrawStringAnchored(time, float64(AutoInt.Display.Width)-wtime, float64(AutoInt.Display.Height)-14, 1.0, 1.0)
	AutoInt.Screen.DrawStringAnchored(time, float64(currentTime.Second()), float64(currentTime.Second()), 0, 0)
